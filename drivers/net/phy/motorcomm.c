...
#define YT_LINUX_SUBVERSION 	22935
#define YT_LINUX_VERSIONID  	"2.2.22935"
...
static int yt8521_delaysel_init(struct phy_device *phydev)
{
	...
	val = 0x8140;
	ret = ytphy_write_ext(phydev, YT8521_EXTREG_RGMII_CONFIG2, val);
...
static int yt8521_config_init(struct phy_device *phydev)
{
	...
	if ((phydev->phy_id & 0xffffffff) == PHY_ID_YT8531S)
	{
	...
	printk(KERN_INFO "yt8521_config_init end, init successful.\n");
	return ret;
}
